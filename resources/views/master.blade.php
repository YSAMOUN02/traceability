            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Select Traceability to
                            continue.
                            @php
                                $date = App\Models\Item_ledger_entry::orderby('entry', 'desc')
                                    ->select('posting_date')
                                    ->limit(1)
                                    ->first();
                            ...
                            Last Data Updated : {{ $date->posting_date }}
                        ...
                        <div class="flex justify-between">
                            <a href="/traceability/lot">
                                <button data-modal-hide="popup-modal" type="button"
                                    class= " text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm inline-flex items-center px-2 py-2.5 text-center">
                                    Traceability by Lot
                                </button>
                            </a>
